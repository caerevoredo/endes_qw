...
use rec0111, clear
merge 1:1 caseid using rec84dv, force
keep if _merge==3
drop _merge
...
*generando violencia psicológica
...
label def violen 1 "Mujer violentada" 0 "Mujer no violentada"
label val violen violen
g hv112=v003

keep hhid hv112 caseid violen violfisosex violensex violenfis violenpsi
save violencia, replace
...
merge m:1 hhid hv112 using violencia
keep if _merge==3
rename _merge _m_viol
